...
#ifndef StudentdeclaratiesH
#define StudentdeclaratiesH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <Mask.hpp>
//---------------------------------------------------------------------------
class TStudentdeclaratiesForm : public TForm
{
...
public:		// User declarations
        __fastcall TStudentdeclaratiesForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TStudentdeclaratiesForm *StudentdeclaratiesForm;
//---------------------------------------------------------------------------
#endif
