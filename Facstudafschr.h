...
#ifndef FacstudafschrH
#define FacstudafschrH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <Menus.hpp>
//---------------------------------------------------------------------------
class TFacStudAfschrijvingForm : public TForm
{
__published:	// IDE-managed Components
        ...
        TDBNavigator *AfschrijvingDBNavigator;
        ...
        void __fastcall AfschrijvingDBNavigatorClick(TObject *Sender,
          TNavigateBtn Button);
        void __fastcall OpslaanButtonClick(TObject *Sender);
private:	// User declarations
public:		// User declarations
        __fastcall TFacStudAfschrijvingForm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFacStudAfschrijvingForm *FacStudAfschrijvingForm;
//---------------------------------------------------------------------------
#endif
